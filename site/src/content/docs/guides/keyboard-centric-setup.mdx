...
:::note
If you want add more Spaces with hotkeys, just follow the same steps - first create as much Spaces as you need, then go back to `Keyboard Shortcuts` and enable checkboxes
:::
...
Also enable space index to visualize your current Space:
