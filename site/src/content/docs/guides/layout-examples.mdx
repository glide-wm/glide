...
1. Start with Window 1 in focus
2. Open Window 2 - it appears next to Window 1
3. Press **Alt+Backslash** to create a horizontal split on the right
4. Press **Alt+T** to convert to a tabbed group
5. Open Window 3 - it appears as a tab
6. Open Window 4 - it appears as a tab

**Key actions:**
- Create horizontal split: **Alt+Backslash**
- Convert to tabbed group: **Alt+T**
...
3. Press **Alt+S** to convert to a stacked group
4. Open Window 2 - it appears in the left stack
5. Press **Alt+L** to move focus to the right
6. Open Window 3 - it appears on the right
7. Press **Alt+Equal** to create a vertical split
8. Press **Alt+S** to convert to a stacked group
9. Open Window 4 - it appears in the right stack
